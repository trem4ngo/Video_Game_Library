...
('Fighting', 'Fast-paced, one-on-one or group combat games where players use melee or martial arts techniques to defeat opponents.'),
...
-- Wallet Data Sets
INSERT INTO Wallets (wallet_balance)
VALUES
(5000.31),(10499.00), (8000.52), (15000.05), (768.30);

-- Users Data Set
INSERT INTO Users (wallet_id, first_name, last_name, birth_date, sex, contact_number, contact_email)
VALUES
...
('Dota 2', 9013-07-09, 'Valve', 'Valve', 0.00);
...
VALUES
(game_id, '2.2.4.3', 2024-12-03, '03:55:00', 'An update has been released for Left 4 Dead 2. 
- Fixed some exploits used to crash remote servers.'),
(game_id, '2.2.4.2', 2024-10-25, '04:58:00', 'Fixed several crash and remote code execution exploits.
...
INSERT INTO Patches (game_id, patch_title, patch_date, patch_time, patch_description)
VALUES
(game_id, 'Moonlight Amidst Dreams', 2025-02-12, '06:00:00', 'New Characters: Embrace of Enchanting Dreams" and Yumemizuki Mizuki (5-Star Anemo Catalyst).
...
(game_id, 'Incandescent Ode of Resurrection', 2025-01-01, '06:00:00', 'New Characters: "Night-Igniting Flame" Mavuika (5-Star Pyro Claymore),
...
Phase II - The Hearths Ashen Shadow (Arlecchino & Lan Yan), Illuminating Lightning (Clorinde & Lan Yan),
Remembrance of Jade and Stone (Chronicled Wish)');

SELECT game_id FROM Games WHERE game_name = 'Minecraft';
INSERT INTO Patches (game_id, patch_title, patch_date, patch_time, patch_description)
VALUES
(game_id, '1.21.62', 2025-02-25, 'Gameplay: Fixed an issue where attacking a mob while sprint jumping would remove all player momentum (MCPE-189501) 
...
(game_id, '1.21.51', 2024-12-11, 'General: Fixed several crashes that could occur during gameplay, 
Fixed issue where some shaped recipes were not parsing properly, 
